...
def process_resource(res_):
    for row in res_:
        ...
        change_charts = []
        if row['code'].startswith('0000'):
            chart, layout = history_chart(row)
            if chart is not None:
                change_charts.append(
                    {
                        'title': 'נומינלית',
                        'long_title': 'ערכי ההכנסה לאורך השנים (כפי שהופיעו בספרי ההכנסה)',
                        'type': 'plotly',
                        'chart': chart,
                        'layout': layout
                    }
            ...
            if chart is not None:
                change_charts.append(
                    {
                        'title': 'באחוזים מכלל ההכנסה',
                        'long_title': 'ערכי ההכנסה לאורך השנים כאחוז מכלל ההכנסה',
                        'type': 'plotly',
                        'chart': chart,
                        'layout': layout
                    }
